...
import '../../src/repositories/objectbox/task_model.dart';

export 'package:objectbox/objectbox.dart'; // so that callers only have to import this file

final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
      id: const obx_int.IdUid(1, 6080109550082607012),
      name: 'TaskModel',
      lastPropertyId: const obx_int.IdUid(3, 8461863441581039125),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 491183026377567906),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 3973399585912053091),
            name: 'description',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 8461863441581039125),
            name: 'isCompleted',
            type: 1,
            flags: 0)
      ],
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
      entities: _entities,
      lastEntityId: const obx_int.IdUid(1, 6080109550082607012),
...
class TaskModel_ {
  ...
  static final isCompleted =
      obx.QueryBooleanProperty<TaskModel>(_entities[0].properties[2]);
}
